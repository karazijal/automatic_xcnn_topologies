...
def get_eqsplit_id_xcon(nb_classes):
    ...
    Ycon = merge([poolY, poolU, poolV], mode='concat', concat_axis=pr_axis)
    Ucon = merge([poolY, poolU, poolV], mode='concat', concat_axis=pr_axis)
    Vcon = merge([poolY, poolU, poolV], mode='concat', concat_axis=pr_axis)
